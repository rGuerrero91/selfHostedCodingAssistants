...
- Replace its contents with the config below, substituting the LAN IP Address for the machine running Ollama (if it's running on the same machine you can use the internal home IP)
